...
def meshing(domain, arg2, rotation_axis, number_degrees, methode):
    ...
    rotation = R.from_euler(rotation_axis, number_degrees, degrees=True).as_matrix()

    x = np.linspace(arg2[0][0], arg2[0][1], arg2[0][2])
    y = np.linspace(arg2[1][0], arg2[1][1], arg2[1][2])
    z = np.linspace(arg2[2][0], arg2[2][1], arg2[2][2])
    ...
    mesh = refine_tree_xyz(mesh, np.asarray(sphere_xyz), octree_levels=[2, 2, 2], method= methode, max_distance=10, finalize=False)
...
domain = ((-1000, 1000), (-1000, 1000), (-1000, 1000))
arg2 = ((-500, 500, 50), (-500, 500, 50), (-500, 500, 50))
axis = 'X'
degrees = 10

meshing(domain, arg2, axis, degrees, methode="surface")
